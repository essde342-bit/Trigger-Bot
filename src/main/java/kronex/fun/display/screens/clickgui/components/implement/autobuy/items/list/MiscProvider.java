...
public class MiscProvider {
    public static List<AutoBuyableItem> getMisc(){
        ...
        for(String[] v:values)r.add(new CustomItem(v[0],v[1],v[2],null,switch(v[0]){case "Алмаз"->Items.DIAMOND;case "Золотое яблоко"->Items.ENCHANTED_GOLDEN_APPLE;case "Незеритовый слиток"->Items.NETHERITE_INGOT;default->Items.TOTEM_OF_UNDYING;},Defaultpricec.getPrice(v[2]),null,null));
        return r;
    }
}
