package kronex.fun.display.screens.clickgui.components.implement.autobuy.util.krushprovider;
...
public class KrushItem implements AutoBuyableItem {
    ...
    public KrushItem(String displayName, Item material, ItemStack reference, int price) {
        this.displayName=displayName;this.material=material;this.reference=reference;this.price=price;this.enabled=true;
    ...
    public String getBuyName(){return displayName;}
    public String getParseName(){return displayName.replaceAll("^\\[.+?\\]\\s*","");}
    public ItemStack createItemStack(){return reference.copy();}
